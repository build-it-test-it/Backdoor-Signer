...
class BreakpointsViewController: UIViewController {
    ...
    private let tableView: UITableView = {
        ...
        tableView.register(BreakpointTableViewCell.self, forCellReuseIdentifier: BreakpointTableViewCell.reuseIdentifier)
        return tableView
    }()
    ...
    @objc private func handleBreakpointAdded(_ notification: Notification) {
        // Reload breakpoints
        reloadBreakpoints()
    }
    
    @objc private func handleBreakpointRemoved(_ notification: Notification) {
        // Reload breakpoints
        reloadBreakpoints()
    }
...
extension BreakpointsViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: BreakpointTableViewCell.reuseIdentifier, for: indexPath) as? BreakpointTableViewCell else {
