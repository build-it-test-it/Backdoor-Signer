...
class ModelServerIntegrationViewController: UIViewController {
    ...
    private func setupUI() {
        ...
        explanationLabel
            .text =
            "When you upload your trained model to the server, it is combined with models from other users to create an improved ensemble model. This helps everyone get better AI performance. Your data remains private, only the model parameters are shared."
