...
class AddIdentifierViewController: UITableViewController {
    ...
    private let replacementTextField: UITextField = {
        ...
        textField.placeholder = String
            .localized("APP_SIGNING_VIEW_CONTROLLER_CELL_SIGNING_OPTIONS_IDENTIFIERS_ID_REPLACEMENT")
        textField.borderStyle = .none
        textField.translatesAutoresizingMaskIntoConstraints = false
        return textField
    }()
    ...
    init(mode: IdentifierMode) {
        ...
        switch mode {
        case .bundleId:
            identifierTextField.placeholder = String
                .localized("APP_SIGNING_VIEW_CONTROLLER_CELL_SIGNING_OPTIONS_IDENTIFIERS_ID")
            replacementTextField.placeholder = String
                .localized("APP_SIGNING_VIEW_CONTROLLER_CELL_SIGNING_OPTIONS_IDENTIFIERS_ID_REPLACEMENT")
        case .displayName:
            identifierTextField.placeholder = String
                .localized("APP_SIGNING_VIEW_CONTROLLER_CELL_SIGNING_OPTIONS_DISPLAYNAMES_ID")
            replacementTextField.placeholder = String
                .localized("APP_SIGNING_VIEW_CONTROLLER_CELL_SIGNING_OPTIONS_DISPLAYNAMES_ID_REPLACEMENT")
        }
    }
        ...
        case 1:
            if replacementTextField.superview == nil {
                ...
                NSLayoutConstraint.activate([
                    ...
                    replacementTextField.leadingAnchor
                        .constraint(equalTo: cell.contentView.layoutMarginsGuide.leadingAnchor),
                    replacementTextField.trailingAnchor
                        .constraint(equalTo: cell.contentView.layoutMarginsGuide.trailingAnchor),
                ])
            }
